...
public class Cheque implements Serializable {
	...
	@JoinColumn(name = "cod_conta", referencedColumnName = "cod_conta", insertable = false, updatable = false)
	...
	@OnDelete(action = OnDeleteAction.CASCADE)
	@JoinColumn(name = "cod_lancamento", referencedColumnName = "cod_lancamento", nullable = false)
